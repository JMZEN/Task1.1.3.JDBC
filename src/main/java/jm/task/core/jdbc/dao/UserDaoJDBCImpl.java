...
public class UserDaoJDBCImpl implements UserDao {
    ...
    public void dropUsersTable() {
        try (PreparedStatement preparedStatement = util.getConnection()
                .prepareStatement("DROP TABLE IF EXISTS UsersDataBase")) {
    ...
    public void saveUser(String name, String lastName, byte age) {
        try (Connection connection = util.getTransactedConnection();
             PreparedStatement preparedStatement = connection
                     .prepareStatement("INSERT INTO UsersDataBase (name, lastName, age) VALUES( ?, ?, ?)")) {
    ...
    public void removeUserById(long id) {
        try (PreparedStatement preparedStatement = util.getConnection()
                .prepareStatement("DELETE FROM UsersDataBase WHERE id = ?")) {
    ...
    public List<User> getAllUsers() {
        ...
        try (PreparedStatement preparedStatement = util.getConnection()
                .prepareStatement("SELECT * FROM UsersDataBase");
    ...
    public void cleanUsersTable() {
        try (PreparedStatement preparedStatement = util.getConnection()
                .prepareStatement("DELETE FROM UsersDataBase")) {
            preparedStatement.executeUpdate();
